...
Color alertColor = const Color(0xFFFF5C83);
Color greenColor = const Color(0xFF2A8D4D);
Color priceColor = const Color(0xFF4141A4);
...
Color backgroundColor4 = const Color(0xFF242836);
